...
homepage:
  ...
  summary: >-
    B2B surface on sovereign AI, edge nodes, and agent runtime — in the SEO/dev attention set. Canonical domain recovering; preview live on Vercel.
  metricLabel: Site
  metricValue: Preview live
  tag: SaaS
